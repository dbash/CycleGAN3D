...
with tf.Session() as sess:
    a_real = tf.placeholder(tf.float32, shape=[None,crop_size, crop_size, crop_size, 3])
    ...
    a_real_ipt = np.zeros((1, len(a_real_ipt_ori), crop_size, crop_size, crop_size, 3))
    a_real_ipt[0,...] = im.imresize(a_real_ipt_ori, [crop_size, crop_size, crop_size])
